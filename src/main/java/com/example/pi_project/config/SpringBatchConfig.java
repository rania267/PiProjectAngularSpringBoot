...
public class SpringBatchConfig  {
    ...
    public FlatFileItemReader<Customer> reader() {
        ...
        itemReader.setResource(new FileSystemResource("src/main/resources/customerstest.csv"));
    ...
    private LineMapper<Customer> lineMapper() {
        ...
        lineTokenizer.setNames("id", "firstName", "lastName", "email", "gender", "CIN", "Age", "date", "nombre_enfance","Etat_civil","Bourse","Score","type");
